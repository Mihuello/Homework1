...
public class Employee {
    public static void main(String[] args) {
        ...
        int technicalSpecialist = programmers + testersOnProject + supportOnProject;
        ...
        System.out.println("Специалистов поддержки, необходимое, чтобы обработать вопросы, возникающие у пользователей по поводу кода, написанного одним программистом: " + support);
